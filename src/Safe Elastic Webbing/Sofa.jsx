...
export default function Elastic() {
  ...
  return (
    <>
            ...
            <div className="md:py-32 py-16">
                ...
                <div className='flex grid-cols-3 md:max-w-screen-md md:pt-0 pt-60'>
                    <div className='w-full'>
                        <h1 data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="400" className='border px-2 py-2 border-black border-opacity-20 md:text-base text-xs'>
                            Type 1 - Type 3 
                        </h1>
        ...
        <div data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="400" className='hidden md:block lg:block mt-10'>
            <Animate/>
        </div>
    </div>
    </div>
