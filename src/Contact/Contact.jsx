                        ...
                        <div className='mx-auto'>
                            <div className='md:grid md:grid-cols-2 lg:gap-x-8 mx-auto justify-center'>
                                <div className='lg:py-3 md:py-3 py-2'>
                                    ...
                                    <input
                                        className='bg-[#f0f0f0] border mt-2 py-2 w-full px-4 mx-auto border-[#1591B3] shadow-lg'
                                        type="text"
                                        value={first_name}
                                        required
                                ...
                                <div className='lg:py-3 md:py-3 py-2'>
                                    ...
                                    <input
                                        className='bg-[#f0f0f0] border mt-2 py-2 w-full px-4 mx-auto border-[#1591B3]'
                                        type="text"
                                        value={last_name}
                                        required
                            ...
                            <div className='mt-5'>
                                ...
                                <textarea
                                    className='bg-[#f0f0f0] border pb-40 py-5 w-full px-4 mx-auto mt-2 overflow-y-hidden border-[#1591B3]'
                                    type="message"
                                    id="message"
                                    value={message}
                                    required
                            ...
                            <div className='items-center'>
                                <button className='bg-gradient-to-r from-[#11AE88] to-[#1591B3] px-10 tracking-wider py-2 md:mt-10 mt-5 text-white' type="submit">
