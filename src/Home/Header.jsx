    ...
    <>
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#] md:py-2 border-b bg-white">
              ...
              >
                ...
                <li>
                  <Link to="/about-us" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link to="/mattress-edge" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Mattress Tape Edge
                  </Link>
                </li>
                <li>
                  <Link to="/mattress-fabric" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Mattress Fabric
                  </Link>
                </li>
                <li>
                  <Link to="/safe-elasti" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Safe Elastic Webbing
                  </Link>
                </li>
                <li>
                  <Link to="/catalouge" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Catalouge
                  </Link>
                </li>
                <li>
                  <Link to="/certificates" className="tracking-wider hover:bg-[#f1f1f1] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#403f68] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Certificates
                  </Link>
                </li>
                <li>
