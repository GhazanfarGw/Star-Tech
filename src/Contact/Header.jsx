...
function Logo({ isScrolled }) {
  ...
  return (
    <>
            ...
            <header onClick={handleScrollToTop} className="fixed z-50 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#fff] md:py-5 py-2 shadow-md">
              <div className='z-20 lg:block md:block hidden'>
                <div className='max-w-screen-2xl mx-auto'>
                  <div className='flex bg-[#146690] bg-opacity-80 rounded-full'>
                    <a 
              ...
              <div className="mx-auto items-center duration-500">
                <div className="flex items-center">
                  <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
                    ...
                    <div className="hidden lg:block duration-500 scroll-smooth py-3">
      ...
      <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:pb-2 bg-white shadow-lg">
        <div className='max-w-screen-2xl mx-auto'>
          <div className='flex bg-[#ffffff] bg-opacity-40 rounded-full'>
            <a 
              href="/contact-us" className="text-[#000000] hover:font-semibold items-center relative h-6 text-xs duration-200 px-8 flex rounded-sm">
              Contact Us
            </a>
          </div>
        </div>
              ...
              <div className="items-center flex flex-row space-x-2 justify-end">
                <div className='flex items-center mx-3'>
                  <a
                    href="/"
                    className="
                      items-center text-base md:text-sm md:hover:border-b border-[#146690] relative h-8 duration-200 lg:px-8 md:px-4 px-4 flex justify-center flex-row text-[#000] font-bold tracking-wide"
                    >
                      Home
                    </a>
                    <a
