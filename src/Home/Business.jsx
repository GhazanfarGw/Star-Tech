...
function Post() {
  ...
  return (
    <div className='mx-auto px-5 items-center md:py-20 bg-[#111316]'>
      <div className='max-w-screen-xl mx-auto text-[#fff]'>
...
//         <Slider {...settings} className='flex mx-auto items-center gap-5 pt-5 text-[#fff]'>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full md:my-7 w-48 hover:scale-105 mt-6 hover:px-4 items-center text-[#fff] font-light scroll-smooth duration-500 bg-[#136690] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full w-48 mt-2 hover:scale-105 hover:px-4 items-center text-[#fff] font-light scroll-smooth duration-500 bg-[#136690] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full md:my-5 w-48 hover:scale-105 mt-5 hover:px-4 items-center text-[#fff] font-light scroll-smooth duration-500 bg-[#136690] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
          ...
          //       </p>
          //     </a>
          //     <div className="text-xs fourth mx-auto rounded-full w-48 hover:scale-105 hover:px-4 items-center text-[#fff] font-light scroll-smooth duration-500 bg-[#136690] relative h-8 tracking-wide uppercase justify-center text-center flex">
          //       <a 
          //         href="/contact-us">
          //         Click For More
          //       </a>
