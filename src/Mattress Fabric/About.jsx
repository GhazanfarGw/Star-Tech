...
const About = () => {
    ...
    return (
        ...
        <div className="max-w-screen-xl mx-auto text-center md:px-10 px-5 pt-20 md:pt-60 pb-20">
            <div data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="400" className="md:flex items-center justify-center mb-4">
            ...
            <p data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="400" className="text-black md:text-lg leading-relaxed text-sm">
            ...
            <p data-aos="zoom-in-up" data-aos-delay="200" data-aos-duration="400" className="text-black md:text-lg leading-relaxed text-sm mt-5">
