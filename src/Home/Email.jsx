...
function EmailForm() {
  ...
  return (
    <form className='text-[#146690]' onSubmit={handleSubmit}>
      { !success && <div>
        <input
          className='bg-[#fff] border-b border-[#aaaaaa] py-2 w-72 px-4 justify-center text-center mx-auto text-[#146690]'
        ...
        />
        <div>
          <button className='bg-[#fff] px-10 tracking-wider py-2 md:mt-10 mt-5 text-[#146690] font-semibold' type="submit">
