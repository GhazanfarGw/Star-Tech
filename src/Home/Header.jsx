  ...
  return (
    <>
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-50 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#fff] md:py-5 py-2 shadow-md">
              ...
              >
                ...
                <li>
                  <Link to="/sofe-elastic" className="tracking-wider hover:bg-[#000000] px-8 py-3 flex flex-row items-center duration-200 border-b hover:text-[#146690] text-[#000] border-[#000] border-opacity-10 text-sm font-semibold">
                    Sofe Elastic Webbing
                  </Link>
                </li>
                <li>
      ...
      <header className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center md:pb-2">
        <div className='max-w-screen-2xl mx-auto'>
          <div className='flex bg-[#000000] bg-opacity-70 rounded-full'>
            <a 
              href="/contact-us" className="text-[#ffffff] hover:font-semibold items-center relative h-6 text-xs duration-200 px-8 flex rounded-sm">
              Contact Us
            </a>
      ...
      <div className="mx-auto items-center duration-500 md:pt-8">
        <div className="flex items-center">
          <div className="flex items-center max-w-screen-2xl justify-between mx-auto w-full">
            ...
            <div className="hidden lg:block duration-500 scroll-smooth py-3">
              <div className="items-center flex flex-row space-x-2 justify-end py-3 rounded-full duration-500 bg-black bg-opacity-70">
