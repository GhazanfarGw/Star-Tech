    ...
    <div className='md:px-10 items-center mx-auto justify-center px-5 md:py-20 py-10'>
      <div className='max-w-screen-2xl mx-auto justify-center'>
        ...
        <div className='flex lg:grid-cols-4 pb-5 overflow-x-scroll xl:overflow-hidden mx-auto gap-5 md:gap-10 justify-between items-center'>
          <a href='/mattress-edge' className='justify-center hover:bg-[#f1f1f1] border-[#403f68] border-opacity-20 border rounded-xl shadow-xl'>
            <div className='px-3 py-4 items-center w-80 lg:w-[22rem]'>
              ...
              <div className='pt-5 px-5'>
                ...
                <p className='lg:text-base text-sm pt-3 border-t border-[#403f68] border-opacity-20 hover:text-[#403f68] text-[#65666d]'>
                  Learn More
                </p>
              </div>
            </div>
          </a>
          <a href='/mattress-fabric' className='justify-center hover:bg-[#f1f1f1] border-[#403f68] border-opacity-20 border rounded-xl shadow-xl'>
            <div className='px-3 py-4 items-center w-80 lg:w-[22rem]'>
          ...
          <a href='/safe-elastic' className='justify-center hover:bg-[#f1f1f1] border-[#403f68] border-opacity-20 border rounded-xl shadow-xl'>
            <div className='px-3 py-4 items-center w-80 lg:w-[22rem]'>
          ...
          <a href='/catalouge' className='justify-center hover:bg-[#f1f1f1] border-[#403f68] border-opacity-20 border rounded-xl shadow-xl'>
            <div className='px-3 py-4 items-center w-80 lg:w-[22rem]'>
              <img className='w-96' src='./cutain.jpg' alt='images'/>
              <div className='pt-5 px-5'>
                <h1 className='font-semibold lg:text-lg text-base'>
