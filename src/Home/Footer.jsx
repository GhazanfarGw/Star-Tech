...
const Footer = () => {
    ...
    return (
              <div className='bg-[#121416] z-10 relative'>
                <div className='max-w-screen-xl mx-auto justify-center md:pt-20 md:pb-10 md:px-10 md:py-10 pt-7'>
                  ...
                  <div className='md:grid md:grid-cols-4 md:gap-8 max-w-screen-2xl mx-auto justify-center py-5 text-[#A39896] px-7'>
                    <div className=''>
                        ...
                        <p className='text-sm text-[#fff] md:pt-4 pt-3'>
                            The legacy of the Startech Fzc was incepted 
                            25Years ago with an aim to manufacture wide 
                            range of Products in United Arab Emirates. The 
                            Global Leader of the Woven Label and Printed 
                            label industry since 1997. We are Pioneers of 
                            label manufacturing in the UAE.
                        </p>
                    </div>
                    <ul className='md:pt-0 pt-10'>
                        <il className='text-[#A39896] text-base justify-center font-semibold'>
                            Contact Us
                        </il>
                        <li className='text-sm text-[#fff] md:pt-4 pt-2'>
                            office@startech.ae
                        </li>
                        <li className='text-sm text-[#fff] md:pt-4 pt-2'>
                           Head Office Number: +971 6 55 72909
                        </li>
                    </ul>
                    <div className='md:pt-0 pt-10'>
                        <h1 className='text-[#A39896] text-base justify-center font-semibold'>
                            Address
                        </h1>
                        <p className='text-sm text-[#fff] md:pt-4 pt-2'>
                            G2 – 13 SAIF ZONE, SHARJAH UAE
                        </p>
                    </div>
                    <div className='md:pt-0 pt-10'>
                        <h1 className='text-[#A39896] text-base justify-center font-semibold'>
                ...
                <div className='justify-center mx-auto md:text-center pt-3 px-5 border-t border-[#146690]'>
