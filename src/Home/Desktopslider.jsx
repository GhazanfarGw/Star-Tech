...
const slides = [
    {
        ...
        text:' The legacy of the Startech was incepted 25Years ago with an aim to manufacture Knitted Products in United Arab Emirates, We are experts in the manufacturing for more than 25 years.'
    },

    {
        eachSlide: 'url(./MattressEdgeTape.jpg)',
        heading: 'Mattress Taps Edge',
...
const Dashboard = () => {
    ...
    const renderSlides = () => slides.map((item, index) => (
        <div 
            ...
            <div
            className='text-white bg-black relative top-0 bottom-0 bg-opacity-50 xl:mx-44 xl:my-80 xl:py-32 lg:mx-20 lg:my-80 lg:py-20 md:my-60 md:py-32 md:mx-20 my-40 py-16 mx-10 px-5 items-center justify-center text-center'>
